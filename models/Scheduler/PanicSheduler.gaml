...
//		pedMaxSpeed <- pedDesiredSpeed*1.3;
		...
		create panicPeople number: number_of_people;
...
experiment helbingPanicSimulation type: gui
{
	...
	output
	{
		...
		{
			chart "Number of panicPeoples still inside " {
				data "nb_panicPeople" value: nb_panicPeople;
				
			}
			
			
		}
		monitor "Nb panicPeople" value:nb_panicPeople;
